...
public class Question5Handler : QuestionHandler
{


    [SerializeField] private GameObject parta;
    [SerializeField] private GameObject partb;
    [SerializeField] private GameObject partc;
    ...
    void Start()
    {
        ...
        partc = gameObject.transform.GetChild(3).gameObject;
        bagRock = VisualTestUI.transform.GetChild(4).gameObject.transform.GetChild(5).gameObject;
    }
    ...
    void Update()
    {
        ...
        if (parta.GetComponent<ItemSlot>().isAccepted() && partb.GetComponent<ItemSlot>().isAccepted() && partc.GetComponent<ItemSlot>().isAccepted())
        {
            gameObject.transform.GetChild(4).gameObject.SetActive(true);

            if (questionDone)
                VisualTestUI.GetComponent<UIHandler>().CancelQuestion5();
            else
