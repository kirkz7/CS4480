...
public class Question6Handler : QuestionHandler
{
    ...
    void Start()
    {
        ...
        bagRock = VisualTestUI.transform.GetChild(4).gameObject.transform.GetChild(6).gameObject;
    }
    ...
    void Update()
    {
        ...
        if (parta.GetComponent<ItemSlot>().isAccepted())
        {
            ...
            if (questionDone)
                VisualTestUI.GetComponent<UIHandler>().CancelQuestion6();
            else
