...
public class Question2Handler : QuestionHandler
{
    ...
    void Start()
    {
        ...
        bagRock = VisualTestUI.transform.GetChild(4).gameObject.transform.GetChild(2).gameObject;
    }
    ...
    void Update()
    {
        ...
        if (parta.GetComponent<ItemSlot>().isAccepted() && partb.GetComponent<ItemSlot>().isAccepted())
        {
            ...
            if (questionDone)
                VisualTestUI.GetComponent<UIHandler>().CancelQuestion2();
            else
